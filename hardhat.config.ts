 ...
 */
// prettier-ignore
const ETHEREUM_MAINNET_KEY: string = process.env.ETHEREUM_MAINNET_KEY ?
process.env.ETHEREUM_MAINNET_KEY : "";
// prettier-ignore
const ETHEREUM_TESTNET_KEY: string = process.env.ETHEREUM_TESTNET_KEY ?
    process.env.ETHEREUM_TESTNET_KEY : "";
// See `config.networks`.
